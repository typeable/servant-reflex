...
--   clientWithRoute Proxy _ _ req baseurl opts wrap trigs =
...
--   clientWithRoute Proxy _ _ req baseurl opts wrap trigs = do
...
--   clientWithRoute Proxy q t req baseurl opts wrap eVal =
--     clientWithRoute
...
--   clientWithRoute Proxy q t req baseurl opts wrap mparam =
...
--   clientWithRoute Proxy q t req baseurl opts wrap paramlist =
--     clientWithRoute (Proxy :: Proxy sublayout) q t req' baseurl opts wrap
...
--   clientWithRoute Proxy q t req baseurl opts wrap flag =
--     clientWithRoute (Proxy :: Proxy sublayout) q t req' baseurl opts wrap
...
--   clientWithRoute _ _ _ _ baseurl _ wrap xhrs triggers = do
...
--   clientWithRoute Proxy q t req baseurl opts wrap body =
--     clientWithRoute (Proxy :: Proxy sublayout) q t req' baseurl opts wrap
...
--   clientWithRoute Proxy q t req baseurl opts wrap =
--      clientWithRoute (Proxy :: Proxy sublayout) q t
...
--   clientWithRoute Proxy q t req baseurl opts wrap authdata =
--     clientWithRoute (Proxy :: Proxy api) q t req' baseurl opts wrap
--       where
